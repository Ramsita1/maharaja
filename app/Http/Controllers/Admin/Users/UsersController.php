...
class UsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user->store_id = ($request->input('store_id')?$request->input('store_id'):0);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->input('tab') == 'StoreEmployee') {
            $route = route('stores.edit', $user->store_id).'?tab=StoreEmployee';
