	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="card">
		   	<div class="card-block table-border-style">
		   		<?php 
		   		$storeOrder = \App\StoreOnlineOrderTimings::where('store_id', $store->store_id)->where('type' ,'StoreOnlineOrderTimings')->get()->first();
		   		...
		   		?>
			   		<input type="hidden" name="type" value="StoreOnlineOrderTimings">
