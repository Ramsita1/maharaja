               ...
               <table border="0" cellpadding="0" cellspacing="0" width="600px" class="main_outter" style="width:600px;margin:auto;">
                  <tr>
                     <td align="center" valign="top" id="templatePreheader" style="padding:28px 15px;background: #fff;">
                        ...
                        <p style="color: #152c3b;">You have successfully registered on our website and your email id is verified.</p>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                           <tr>
                              <td bgcolor="#f3da09" style="padding: 12px 28px 12px 28px; border-radius:3px" align="center">
                              	<a href="<?php echo siteUrl(); ?>/login" style="font-size: 16px; font-weight: normal; color: #152c3b; text-decoration: none; display: inline-block;">Click to Login</a></td>
                           </tr>
                        </table>
                     </td>
                  </tr>
