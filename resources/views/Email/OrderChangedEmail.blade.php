    ...
    <body style="width:600px;margin:auto;background: #ececec;" width="600px">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="600px" id="bodyTable" style="background: #ececec;padding: 20px 0 40px;" >
           <tr>
                ...
                <table align="center" border="0"  height="100%" width="600px" class="main_outter" style="width:600px;margin:auto;" >
                 <tr>
                 <td>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%"  style="margin:auto;width:100%;">
                        <tr>
                                <td align="center" valign="top" id="templatePreheader" style="padding:15px 15px;background: #f3da09;">
                                    <h1 style="color: #152c3b;"><?php echo $title ?></h1>
                                </td>
                        </tr>
                        <tr>    
                            <td align="left" valign="top" id="templateinner" style="padding:28px 15px 10px;background: #fff;">  
                                <p style="color: #152c3b;"><?php echo $message ?>:</p>  
