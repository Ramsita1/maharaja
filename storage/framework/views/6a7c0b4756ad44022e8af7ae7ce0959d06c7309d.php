	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="card">
		   	<div class="card-block table-border-style">
		   		<?php 
		   		$storeOrder = \App\StoreOnlineOrderTimings::where('store_id', $store->store_id)->where('type' ,'StoreOnlineOrderTimingsDelivery')->get()->first();
		   		...
		   		?>
			   		<input type="hidden" name="type" value="StoreOnlineOrderTimingsDelivery">
...
</div><?php /**PATH /home/k9c9adh99pg7/public_html/pza/resources/views/Admin/Store/StoreOnlineOrderTimingsDelivery.blade.php ENDPATH**/ ?>