	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3 text-center animate-box">
				<div class="chef-wrap">
					<div class="chef-img" style="background-image: url(<?php echo publicPath() ?>/front/images/chef-1.jpg);"></div>
					<div class="desc">
						<h3>Liam Anderson</h3>
						<span>Head Chef</span>
					</div>
			...
			<div class="col-md-3 text-center animate-box">
				<div class="chef-wrap">
					<div class="chef-img" style="background-image: url(<?php echo publicPath() ?>/front/images/chef-2.jpg);"></div>
					<div class="desc">
						<h3>Liam Anderson</h3>
			...
			<div class="col-md-3 text-center animate-box">
				<div class="chef-wrap">
					<div class="chef-img" style="background-image: url(<?php echo publicPath() ?>/front/images/chef-3.jpg);"></div>
					<div class="desc">
						<h3>Liam Anderson</h3>
						<span>Assistant Chef</span>
					</div>
			...
			<div class="col-md-3 text-center animate-box">
				<div class="chef-wrap">
					<div class="chef-img" style="background-image: url(<?php echo publicPath() ?>/front/images/chef-4.jpg);"></div>
					<div class="desc">
						<h3>Liam Anderson</h3>
						<span>Waiter</span>
					</div>
...
</div><?php /**PATH C:\xampp\htdocs\MaharajaPrestonApi\resources\views/Templates/AboutUs.blade.php ENDPATH**/ ?>