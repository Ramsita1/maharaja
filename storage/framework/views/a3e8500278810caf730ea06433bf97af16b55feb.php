               ...
               <table border="0" cellpadding="0" cellspacing="0" width="600px" class="main_outter" style="width:600px;margin:auto;">
                  <tr>
                     <td align="center" valign="top" id="templatePreheader" style="padding:28px 15px;background: #fff;">
                        ...
                        <p style="color: #152c3b;">Password: <?php echo $password ?>,</p>
                        <p style="color: #152c3b;">Please click the button below to verify your email address.</p>
                        <p style="color: #152c3b;">If you already sign up please ignore this email or Login into <a href="<?php echo siteUrl(); ?>">infiway.com</a></p>
                        <table border="0" cellspacing="0" cellpadding="0">
                           <tr>
                              <td bgcolor="#f3da09" style="padding: 12px 28px 12px 28px; border-radius:3px" align="center"><a href="<?php echo $link; ?>" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #152c3b; text-decoration: none; display: inline-block;">Verify Email</a></td>
                           </tr>
                        </table>
                     </td>
                  </tr>
...
</html><?php /**PATH /home/k9c9adh99pg7/public_html/pza/resources/views/Email/RegisterVerifyEmailLink.blade.php ENDPATH**/ ?>