<div class="page-body">
   <h3>Edit User</h3>
   <?php echo Form::open(['route' => array('users.update', $user->user_id), 'method' => 'put', 'class' => 'md-float-material']) ?>
      <div class="row">
         <div class="col-md-6">
...
</div><?php /**PATH C:\xampp\htdocs\MaharajaPrestonApi\resources\views/Admin/Users/Edit.blade.php ENDPATH**/ ?>